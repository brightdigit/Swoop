...
enum Notes {
  ...
  // run prerequisites for postgresdb
  // verify docker is install or install docker

  // run prerequisites for server
  // run prerequisites for postgresdb
  // setup environment

  // run prerequisites for app
  // verify prerequisites are installed for app

  // run prerequisites for web
  // verify prerequisites are installed for web
  ...
  // run app [which server]
  // run server? or set host_url
